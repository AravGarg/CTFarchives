...
/*returns number of lines in para file */
...
/*returns pseudo random word from the file after null terminating it */
...
/*initializes the word with blank spaces equal to strlen of realword */
...
/*checks the word for the letter, if yes returns true and sets the word */
